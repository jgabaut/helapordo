 ...
 */
typedef enum GameScreen { LOGO = 0, TITLE, SAVES_VIEW, NAMEPICK_VIEW, CLASSPICK_VIEW, FLOOR_VIEW, ROOM_VIEW, UNLOCK_SPECIAL_VIEW, PICK_SPECIAL_VIEW, EQUIPS_VIEW, OPEN_BAG_VIEW, CHECK_LOADOUT_VIEW, CONSUMABLES_VIEW, STATS_VIEW, ARTIFACTS_VIEW, ENDING, DOOR_ANIM, CHEST_ANIM,
 ...
 */
#define HELAPORDO_PATCH_VERSION 18
